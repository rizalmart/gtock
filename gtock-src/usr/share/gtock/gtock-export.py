# gtock-export-py - This exports crontab and at tasks with their info
# to the file specified.
#
# Copyright (C) 2023  Gaute Hope <eg at gaute dot vetsj dot com>
#
# Forked by rizalmart
#
...
sys.stderr.write(_("gTock: Export tasks") + "\n")
