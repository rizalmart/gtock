...
class Crontab:
    def __init__(self,root,user,uid,gid, user_home_dir):
        ...
        self.crontabdata = self.user_home_dir + "/.config/gnome-schedule/crontab"
    ...
    def set_rights(self,user,uid,gid, ud):
        ...
        if os.path.exists(self.crontabdata) != True:
            try:
                ...
                print (_("Failed to create data dir: %s. Make sure ~/.config and ~/.config/gnome-schedule are writable.") % (self.crontabdata))
