...
class TemplateChooser:
    def __init__ (self, parent, template):
        ...
        self.window = self.builder.get_object("template_chooser")
        self.window.connect("delete-event", self.on_cancel_clicked)


        self.treeview = self.builder.get_object("tc_treeview")
        self.button_use = self.builder.get_object("tc_button_use")
        hbox = Gtk.HBox ()
        icon = Gtk.Image ()
        ...
        self.button_cancel = self.builder.get_object("tc_button_cancel")
